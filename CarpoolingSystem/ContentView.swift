...
struct LoginView: View {
            ...
            ScrollView {
                VStack(spacing: 30) {
                    ...
                    VStack(spacing: 20) {
                        ...
                        // MARK: - Email Field
                        VStack(alignment: .leading, spacing: 4) {
                            TextField(showingRegister && selectedRole == .carpooler ? "Email (必须使用 @must.edu.mo)" : "Email", text: $email)
                                .textFieldStyle(RoundedBorderTextFieldStyle())
    ...
    func validateEmailField() {
        ...
        if showingRegister && selectedRole == .carpooler {
...
struct AdvancedSearchView: View {
    ...
    private func performSearch() {
        ...
        results = results.filter { ride in
            ...
            return timeDifference <= 1800  // 30分钟 = 1800秒
        }
